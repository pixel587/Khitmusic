...
import config
from khitmusic import app, YouTube, LOGGER
from config import BANNED_USERS
from khitmusic.utils.database import is_active_chat
from khitmusic.utils.decorators.language import language, languageCB
from khitmusic.utils.exceptions import AssistantErr
from khitmusic.utils.database import get_cmode
...
async def suggestion_play_cb(client, cq, _):
    ...
    try:
        from khitmusic.utils.stream.stream import stream
        await stream(
            client,
            _,
            mystic,
